...
@implementation FLDateFormatManager
...
+ (BOOL)isSameDay:(double)seconds {
  ...
  NSString *time = [FLDateFormatManager
      formatToDateType_yyyyMMdd_withTimeIntervalSince1970:timeNow];
  NSString *time2 = [FLDateFormatManager
...
+ (NSString *)formatToDateType_yyyy_MM_dd_week_HH_MM_withTimeIntervalSince1970:
  ...
  NSString *weekStr = [FLDateFormatManager weekdayStringFromDate:date type:1];
