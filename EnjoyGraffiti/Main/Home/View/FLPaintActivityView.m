...
@interface FLPaintActivityView () <UITableViewDelegate,UITableViewDataSource>
...
@implementation FLPaintActivityView
...
{
    FLPaintHomePaintViewCell *cell = [tableView dequeueReusableCellWithIdentifier:[FLPaintHomePaintViewCell getIdentifier]];
...
- (UITableView *)tableView
{
    if (!_tableView) {
        ...
        [_tableView registerNib:[UINib nibWithNibName:@"FLPaintHomePaintViewCell" bundle:[NSBundle mainBundle]] forCellReuseIdentifier:[FLPaintHomePaintViewCell getIdentifier]];
        
    }
    return _tableView;
}

- (FLPaintHotView *)hotView
{
    if (!_hotView) {
        _hotView = [[FLPaintHotView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 170)];
