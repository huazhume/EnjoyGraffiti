//
//  FLPaintIssiaViewController.m
//  EnjoyGraffiti
//
//  Created by hua on 2020/4/21.
...
@interface FLPaintIssiaViewController ()
<UITextViewDelegate,UIActionSheetDelegate,FLPaintFeedSectionViewDelegate>
...
@property (nonatomic , strong) FLPaintFeedSectionView *sectionView;
@property (nonatomic , strong) UIScrollView *contentView;

@end

@implementation FLPaintIssiaViewController
...
- (void)rightAction {
    ...
    [PTStashFiles stashFilesMethodsOneTest];
    [FLPaintActionAlertView alertShowWithMessage:@"确定提交吗？" leftTitle:@"提交" leftColor:[UIColor colorWithHex:0xCD6256] rightTitle:@"继续" rightColor:[UIColor colorWithHex:0x333333] callBack:^(NSInteger index) {
        if (index == 2){
            return;
        }
...
#pragma mark - FLPaintFeedSectionViewDelegate
...
-(void)sendEmail
{
    ...
    //添加收件人
    NSArray *toRecipients = [NSArray arrayWithObject: @"huanamee@163.com"];
...
- (FLPaintFeedSectionView *)sectionView
{
    if (!_sectionView) {
        _sectionView = [[FLPaintFeedSectionView alloc] initWithFrame:CGRectMake(0, 10, SCREEN_WIDTH, 45)];
