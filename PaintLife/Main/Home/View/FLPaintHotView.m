...
#import "FLPaintPageControl.h"
#import <Masonry/Masonry.h>
#import "FLPaintHotItemView.h"
#import "FLPaintNoteDetailController.h"


@interface FLPaintHotView() <UICollectionViewDataSource, UICollectionViewDelegate>

@property (nonatomic, strong) UICollectionView *collectionView;

@property (nonatomic, strong) FLPaintPageControl *pageControl;
...
{
    //重用
    NSString *identifierString = NSStringFromClass([FLPaintHotBannerCell class]);
    FLPaintHotBannerCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:identifierString forIndexPath:indexPath];
...
- (UICollectionView *)collectionView
{
    if (!_collectionView ) {
        ...
        [_collectionView registerClass:[FLPaintHotBannerCell class] forCellWithReuseIdentifier:identifierString];
    }
    return  _collectionView;
}

- (FLPaintPageControl *)pageControl
{
    if (!_pageControl) {
        _pageControl = [[FLPaintPageControl alloc]initWithFrame:CGRectMake(0, 147, SCREEN_WIDTH, 16)];
