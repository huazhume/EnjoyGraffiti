...
- (UIImage *)floodPaintImageFromStartPoint: (CGPoint) startPoint newColor: (UIColor *)newColor tolerance: (CGFloat)tolerance useAntialias: (BOOL)antialias {
...
//    unsigned char *imageData = (unsigned char *)CFDataGetBytePtr(data);
    ...
    FLLinkedListQueue *points = [[FLLinkedListQueue alloc] initWithCapacity:500 cacheSizeIncrements:500 multiplier:height];
    FLLinkedListQueue *antialiasPoints = [[FLLinkedListQueue alloc] initWithCapacity:500 cacheSizeIncrements:500 multiplier:height];
